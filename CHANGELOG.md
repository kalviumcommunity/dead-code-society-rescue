...
- Restructured flat file into MVC (routes, controllers, services, models)
  Reason: Single routes.js was handling routing, business logic, and DB queries simultaneously (God file).
  Improvement: Each layer has one responsibility, decoupling routing from business logic.

### Performance Fixes

- Fixed N+1 query in shipment listing — replaced loop with .populate()
  Reason: Fetching shipments triggered N additional DB queries.
